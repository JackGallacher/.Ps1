...
#I: Write a function that accepts a computername parameter and retrieves stopped services with
...
#II: Write a script that utilizes the previous function and stores the results in a variable, loop through
...
#III: Write a script that generates an HTML file (day-month-year_machine.html) containing information, 
