...
#I: Start a background job on your local machine to retrieve the system event log, 
...
#II: Start a remote job across multiple machine to retrieve the system event log, 
...
#III: Schedule a job to retrieve security event logs with an eventtype of error
